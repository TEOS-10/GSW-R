...
temperature $\theta$ for all the CTD profiles in `section` is constructed
...
![**Figure 3.** Sea surface Practical Salinity, for Levitus dataset](SSS_1.png)
![**Figure 4.** Sea surface Absolute Salinity minus Practical Salinity, for Levitus dataset.](SSS_2.png)
...
[http://www.tos.org/oceanography/archive/23-3_millero.html](http://www.tos.org/oceanography/archive/23-3_millero.html)

...
<!-- and gsw on his machine. The steps are as follows. ->
<!-- 1. Edit this file-->
<!-- 2. In a console centred in this directory, do -->
<!--     knitr::purl("gsw.Rmd") -->
<!-- to create a new gsw.R file -->
<!-- 3. Run this gsw.R file to update the figures.-->
<!-- 4. Return here, open a console, and do-->
...
```{r eval=eval, results="hide", echo=FALSE}
